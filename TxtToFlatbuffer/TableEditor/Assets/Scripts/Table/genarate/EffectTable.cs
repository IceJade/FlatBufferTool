	...
	public sealed class EffectTable : StringIdConfig
    {
        ...
        public override bool GetBoolValue(string id, string column, bool defaultValue = false)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetBoolValue => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override short GetShortValue(string id, string column, short defaultValue = 0)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetShortValue => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override int GetIntValue(string id, string column, int defaultValue = 0)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetIntValue => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override float GetFloatValue(string id, string column, float defaultValue = 0.0f)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetFloatValue => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override string GetStringValue(string id, string column, string defaultValue = "")
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetStringValue => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override bool[] GetBoolArray(string id, string column)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetBoolArray => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override short[] GetShortArray(string id, string column)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetShortArray => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override int[] GetIntArray(string id, string column)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetIntArray => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override float[] GetFloatArray(string id, string column)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetFloatArray => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override string[] GetStringArray(string id, string column)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetStringArray => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override string GetStringArrayItem(string id, string column, int index, string defaultValue = "")
        {
            ...
            {
                Debug.LogErrorFormat("Table_effect.GetStringArrayItem => index out of array length({0}), [id:{1}, column:{2}, index:{3}]", length, id, column, index);
                return result;
            }
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetStringArrayItem => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override int GetStringArrayLength(string id, string column)
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetStringArrayLength => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override Dictionary<int, int> GetDictionaryII(string id, string column) 
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetDictionaryII => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override Dictionary<int, string> GetDictionaryIS(string id, string column) 
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetDictionaryIS => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override Dictionary<string, int> GetDictionarySI(string id, string column) 
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetDictionarySI => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        public override Dictionary<string, string> GetDictionarySS(string id, string column) 
        {
            ...
            switch (column)
            {
                ...
                default: { Debug.LogErrorFormat("Table_effect.GetDictionarySS => data type is not match, or not find [id:{0}, column:{1}]", id, column); break; }
            }
        ...
        /// <returns></returns>
        public EffectDataRow GetDataRowByIndex(int index)
        {
            Table_effect table = this.GetTable();
            if (null == table.ByteBuffer)
                return null;
            ...
            DReffect? data = table.Data(index);
            if (data.HasValue)
            {
                if (!data_row.ContainsKey(data.Value.Id))
                {
                    EffectDataRow datarow = new EffectDataRow(data.Value, index);
                    data_row.Add(datarow.Id, datarow);
                }
