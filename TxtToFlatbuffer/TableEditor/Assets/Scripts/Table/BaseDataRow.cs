...
namespace Chanto.Table
{
    ...
    public class BaseDataRow
    {
        ...
        /// 分隔符
        /// </summary>
        protected char[] split_chars = new char[] { ';', '|' };
        ...
        */
        ...
        {
            if (value < float.MinValue + 0.0000001f)
                return "";
        ...
        {
            return value < float.MinValue + 0.0000001f ? 0 : value;
        }
        ...
        {
            return value < float.MinValue + 0.0000001f;
        }
