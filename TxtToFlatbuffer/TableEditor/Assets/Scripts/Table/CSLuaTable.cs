...
namespace LF
{
    public class CSLuaTable
    {
        ...
        public int GetInt(string key, int defaultValue = 0)
        {
            ...
            {
                Debug.LogError($"CSLuaTable::GetInt => data type is not match, or not find [id:{this.GetInt("id")}, column:{key}]");
                return defaultValue;
            }
        ...
        public float GetFloat(string key, float defaultValue = 0.0f)
        {
            ...
            {
                Debug.LogError($"CSLuaTable::GetFloat => data type is not match, or not find [id:{this.GetInt("id")}, column:{key}]");
                return defaultValue;
            }
        ...
        public string GetString(string key, string defaultValue = "")
        {
            ...
            //else
            //{
            //    Debug.LogErrorFormat("CSLuaTable::GetString => data type is not match, or not find [id:{0}, column:{1}]", this.GetInt("id"), key);
            //}
